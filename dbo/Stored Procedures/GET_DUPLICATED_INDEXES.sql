--EZMANAGE_
create procedure [dbo].[GET_DUPLICATED_INDEXES] (@DBName nvarchar(250))
as
begin
DECLARE  @First				[smallint]
	...
	--	SELECT @DBName = 'ezCheetahSecondary' --'ezCheetahSecondary'
...
SELECT 
 'OBJECTS-Duplicate Indxes' [Report Category], 
		[Database]
      ,[TableName]
      ,[IndexName]
     -- ,[IndexType]
